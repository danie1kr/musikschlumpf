...
class Schlumpf_Adafruit_VS1053_FilePlayer : public Adafruit_VS1053 {
 public:
  Schlumpf_Adafruit_VS1053_FilePlayer (int8_t mosi, int8_t miso, int8_t clk, 
			      int8_t rst, int8_t cs, int8_t dcs, int8_t dreq,
			      int8_t cardCS);
  Schlumpf_Adafruit_VS1053_FilePlayer (int8_t rst, int8_t cs, int8_t dcs, int8_t dreq,
			      int8_t cardCS);
  Schlumpf_Adafruit_VS1053_FilePlayer (int8_t cs, int8_t dcs, int8_t dreq,
			      int8_t cardCS);
  ...
  boolean startPlayingFile(SdFat &fat, const char *trackname);
